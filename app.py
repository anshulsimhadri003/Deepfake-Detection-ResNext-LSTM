...
video_files1 =  glob.glob('/content/drive/MyDrive/project/Celeb_fake_face_only/*.mp4')
...
video_files2 = glob.glob('/content/drive/MyDrive/project/Celeb_real_face_only/*.mp4')
...
# Run this after Section 4 to verify
if len(video_files1) == 0 or len(video_files2) == 0:
    print("⚠️ WARNING: No video files found!")
    print("Please check your path: /content/drive/MyDrive/project/Celeb_fake_face_only/")
else:
    print(f"✅ Success! Found {len(video_files1)} Fake videos and {len(video_files2)} Real videos.")
...
# df = df.sample(frac=1)
# print(df)
df.to_csv('/content/drive/My Drive/Global_metadata.csv', header=False, index=False)
...
# --- ADD THIS LINE TO CREATE THE MODEL ON GPU ---
model = Model(2).cuda() 
# ------------------------------------------------
